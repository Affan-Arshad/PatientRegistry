...
const submitForm = () => {
    axios.put(`${API_BASE_URL}/addresses/${id.value}`, address.value)
        .then((response) => {
    ...
    <div class="container">
        <div
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group me-2">
                    <button @click="$router.push({ name: 'Addresses' })" type="button"
        ...
        <form v-if="islands.length" @submit.prevent="submitForm">
            <div class="mb-3">
                ...
                <input v-model="address.street_address" type="text" class="form-control">
            </div>
            <div class="mb-3">
                <label class="form-label">Postal Code</label>
                <input v-model="address.postal_code" type="text" class="form-control">
            </div>
            <div class="mb-3">
                <label class="form-label">Island</label>
                <select v-model="address.island_id" class="form-select">
